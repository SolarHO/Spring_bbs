...
<div class="container">
    ...
    <a class="btn btn-primary mb-3" href="${pageContext.request.contextPath}/write?category=${category}">새 게시글 작성</a>
    <table class="table table-bordered">
        ...
        <tbody>
            <c:forEach var="post" items="${posts}">
                <tr>
                    <td>${post.id}</td>
                    <td><a href="${pageContext.request.contextPath}/view?id=${post.id}">${post.title}</a></td>
                    <td>${post.author}</td>
